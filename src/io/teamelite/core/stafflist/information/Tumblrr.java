...
public class Tumblrr {	
	...
	public static String roles() {
		String roles = "Creations, General Moderation";
		return roles;
	}
	
	public static String description() {
		String description = "Does general moderation within the team as well as manages & leads projects within the team.";
		return description;
	}

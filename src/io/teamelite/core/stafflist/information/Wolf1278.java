...
public class Wolf1278 {	
	...
	public static String ingamename() {
		String ingamename = "Wolf1278";
		return ingamename;
	}
	
	public static String rank() {
		String rank = "Site Developer";
		return rank;
	}

	public static String roles() {
		String roles = "Website Development & Management";
		return roles;
	}
	
	public static String description() {
		String description = "Maintains the official team site.";
		return description;
	}
